const menu = [
  ...
  function categoryList() {
      let categoryButton = categories.map(function(category) {
      ...
      let filterButton = document.querySelectorAll(".cat-filter-btn");
      
      filterButton.forEach(function(btn) {
          btn.addEventListener("click", function(e) {
              let category = e.currentTarget.dataset.id;
              let menusCategory = menu.filter(function(menuEl) {
